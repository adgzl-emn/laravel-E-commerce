<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="{{asset('back')}}/pages/dashboard.html">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{route('admin.kategoriler')}}">
                    ...
                    <span class="nav-link-text ms-1">Kategori Yönetimi</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{route('admin.urunler')}}">
                    ...
                    <span class="nav-link-text ms-1">Ürün Yönetimi</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{route('admin.kullanicilar')}}">
                    ...
                    <span class="nav-link-text ms-1">Kullanici Yönetimi</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{route('admin.siparisler')}}">
                    ...
                    <span class="nav-link-text ms-1">Sipariş Yönetimi</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{route('admin.cikis')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>spaceship</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
