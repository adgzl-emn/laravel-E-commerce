                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Üst Kategori</th>
                                ...
                                @foreach($categories as $data)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <a class="btn btn-link text-dark px-3 mb-0" href="{{route('admin.kategori.delete',$data->id)}}" onclick="return confirm('Kayıt Silinicek Emin misin?')"><i class="fas fa-trash text-dark me-2" aria-hidden="true"></i>Sil</a>
                                        </td>
                                    </tr>
                                @endforeach
